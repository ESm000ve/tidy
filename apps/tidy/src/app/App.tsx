...
function MacSelect({
  ...
  return (
    <div className="flex flex-col gap-1 flex-1 select-none">
      <label htmlFor={selectId} className="text-xs font-semibold text-mac-secondary-label tracking-tight">{label}</label>
          ...
          <section aria-label="Filters" className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className={`${GLASS_CLS} p-4 flex items-center justify-between gap-4`} style={GLASS_STYLE}>
                ...
                <Switch checked={excludeHidden} onCheckedChange={setExcludeHidden} aria-labelledby="exclude-hidden-label" aria-describedby="exclude-hidden-desc" color="green" size="md" />
              </div>
