...
import { Dialog, Button } from "@tidy/design-system";
                    ...
                    <Dialog.Portal forceMount>
                        <Dialog.Overlay asChild>
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="fixed inset-0 z-50 bg-vibrancy-overlay backdrop-blur-sm"
                            />
                        </Dialog.Overlay>
                        <Dialog.Content asChild portalled={false}>
                            <motion.div
                            ...
                            >
                                ...
                                <div
                                    className="overflow-hidden rounded-xl flex flex-col bg-background/80 backdrop-blur-xl border border-vibrancy-border shadow-[0_24px_48px_rgba(0,0,0,0.2)] dark:shadow-[0_24px_48px_rgba(0,0,0,0.4)]"
                                    style={{ fontFamily: "var(--font-sf)" }}
                                >
                                    {/* Header */}
                                    <div className="flex items-center justify-between px-5 py-4 border-b border-vibrancy-border">
                                        ...
                                        <Dialog.Close asChild>
                                            <button
                                                ...
                                                className="text-foreground/50 hover:text-foreground/80 hover:bg-vibrancy-hover dark:text-white/50 dark:hover:text-white/80 transition-colors p-1.5 rounded-lg dark:hover:bg-vibrancy-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--mac-focus-ring)]"
                                            >
